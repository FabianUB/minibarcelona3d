...
import enDelays from './locales/en/delays.json';
...
import esDelays from './locales/es/delays.json';
...
import caDelays from './locales/ca/delays.json';
...
i18n
  ...
  .init({
    ...
    fallbackLng: 'en',
    defaultNS: 'common',
    ns: ['common', 'status', 'controlPanel', 'stations', 'settings', 'errors', 'legend', 'vehicles', 'delays'],
