...
- Base map tiles or network data fail to load; the user should see a clear fallback message and retry guidance.
- Geometry for one or more lines is unavailable or incomplete; affected lines should be flagged without breaking the rest of the map.
